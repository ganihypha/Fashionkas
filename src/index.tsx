...
// Health check
app.get('/api/health', (c) => c.json({ status: 'ok', app: 'FashionKas', version: '2.3', webhook: '/api/webhook/incoming', features: ['catalog', 'kasir', 'orders', 'wa-automation', 'r2-upload', 'fonnte-bot', 'subscriptions'] }))
